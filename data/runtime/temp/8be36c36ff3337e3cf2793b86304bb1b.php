<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:37:"themes/simpleboot3/portal\\index.html";i:1506426812;s:35:"themes/simpleboot3/public\head.html";i:1506426812;s:39:"themes/simpleboot3/public\function.html";i:1506426812;s:34:"themes/simpleboot3/public\nav.html";i:1506426812;s:37:"themes/simpleboot3/public\footer.html";i:1506426812;s:38:"themes/simpleboot3/public\scripts.html";i:1506426812;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script src="__STATIC__/js/wind.js"></script>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp59d849aeec892,null,false);
 ?>
</head>
...
function __parse_navigation8131be55737c7fa5295ce8502dd328d1($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation8131be55737c7fa5295ce8502dd328d1';
...
if(''==''): ?>
    <?php echo __parse_navigation8131be55737c7fa5295ce8502dd328d1($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation8131be55737c7fa5295ce8502dd328d1($menus); ?>
    </>
<?php endif; ?>
...
<div class="container">
 ...
 ?>
        ...
        <?php 
         ...
         $__FOR_START_16682__=1;$__FOR_END_16682__=$rows;for($row=$__FOR_START_16682__;$row <= $__FOR_END_16682__;$row+=1){ 
                $first_row = ($row-1)*3;
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp59d849aeec8b3,null,false);
 ?>
    <div class="links">
        <?php
...
<?php 
    \think\Hook::listen('before_body_end',$temp59d849aeec8c3,null,false);
 ?>
</body>
</html>
